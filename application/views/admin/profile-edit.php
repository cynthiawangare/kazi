                  ...
                  <aside class="profile-nav col-lg-3">
                      <section class="panel">
                          ...
                          <ul class="nav nav-pills nav-stacked">
                              ...
                              <li  class="active"><a href="<?php echo site_url('user/profile_edit');?>"> <i class="icon-edit"></i> Complete profile</a></li>
                          </ul>

                      </section>
                  </aside>
                  <aside class="profile-info col-lg-9">
                      <form class="form-horizontal" role="post" method="post" enctype="multipart/form-data" action="<?php echo site_url('user/addpersonaldetailsworker');?>">
                        <section class="panel">
                          ...
                          <div class="panel panel-primary">
                              ...
                              <div class="panel-body">
                                      ...
                                      <select class="form-control m-bot15" name="occupation">
                                              <option value="<?php echo $job->categoryID;?>"><?php echo $job->categoryname;?></option>
                                      ...
                                      <div class="form-group">
                                         <label  class="col-lg-2 control-label">Add Certifications 1</label>
                                         <div class="col-lg-6">
                                           <input type="file" name="certifications" class="file-pos" id="exampleInputFile">
                                           <input type="hidden" name="certifications_" value="<? echo $userdets->cert1;?>">
                                      </div>
                                     </div>

                                     <div class="form-group">
                                         <label  class="col-lg-2 control-label">Add Certifications 2</label>
                                         <div class="col-lg-6">
                                           <input type="file" name="certifications2" class="file-pos" id="exampleInputFile">
                                           <input type="hidden" name="certifications2_" value="<? echo $userdets->cert2;?>">
                                      </div>
                                     </div>

                                     <div class="form-group">
                                         <label  class="col-lg-2 control-label">Add Certifications 3</label>
                                         <div class="col-lg-6">
                                           <input type="file" name="certifications3" class="file-pos" id="exampleInputFile">
                                           <input type="hidden" name="certifications3_" value="<? echo $userdets->cert3;?>">
