                              ...
                              <div class="best-seller">
                                  <article class="media">
                                      <a class="pull-left thumb p-thumb">
                                          <img src="<?php echo base_url();?>assets/back/img/product1.jpg">
                                      </a>
                                  ...
                                  <article class="media">
                                      <a class="pull-left thumb p-thumb">
                                          <img src="<?php echo base_url();?>assets/back/img/product2.png">
                                      </a>
                                      <div class="media-body">
                                  ...
                                  <article class="media">
                                      <a class="pull-left thumb p-thumb">
                                          <img src="<?php echo base_url();?>assets/back/img/product3.png">
                                      </a>
                                      <div class="media-body">
                  ...
                  <div class="col-md-9">
                          ...
                          <div class="panel-body">
                              <div class="col-md-6">
                                  ...
                                  <div class="pro-img-list">
                                      <a href="#">
                                          <img src="<?php echo base_url();?>assets/back/img/product-list/pro-thumb-1.jpg" alt="">
                                      </a>
                                      <a href="#">
                                          <img src="<?php echo base_url();?>assets/back/img/product-list/pro-thumb-2.jpg" alt="">
                                      </a>
                                      <a href="#">
                                          <img src="<?php echo base_url();?>assets/back/img/product-list/pro-thumb-3.jpg" alt="">
                                      </a>
                                      <a href="#">
                                          <img src="<?php echo base_url();?>assets/back/img/product-list/pro-thumb-1.jpg" alt="">
                                      </a>
                          ...
                          <div class="panel-body">
                              <div class="tab-content tasi-tab">
                                  ...
                                  <div id="reviews" class="tab-pane">
                                      <article class="media">
                                          <a class="pull-left thumb p-thumb">
                                              <img src="<?php echo base_url();?>assets/back/img/avatar-mini.jpg">
                                          </a>
                                          <div class="media-body">
                                      ...
                                      <article class="media">
                                          <a class="pull-left thumb p-thumb">
                                              <img src="<?php echo base_url();?>assets/back/img/avatar-mini2.jpg">
                                          </a>
                                          <div class="media-body">
                                      ...
                                      <article class="media">
                                          <a class="pull-left thumb p-thumb">
                                              <img src="<?php echo base_url();?>assets/back/img/avatar-mini3.jpg">
                                          </a>
                                          <div class="media-body">
                      ...
                      <div class="row product-list">
                          <div class="col-md-4">
                              <section class="panel">
                                  <div class="pro-img-box">
                                      <img src="<?php echo base_url();?>assets/back/img/product-list/pro-1.jpg" alt=""/>
                          ...
                          <div class="col-md-4">
                              <section class="panel">
                                  <div class="pro-img-box">
                                      <img src="<?php echo base_url();?>assets/back/img/product-list/pro1.jpg" alt=""/>
                                      <a href="#" class="adtocart">
                                          <i class="icon-shopping-cart"></i>
                                      </a>
                                  </div>
                          ...
                          <div class="col-md-4">
                              <section class="panel">
                                  <div class="pro-img-box">
                                      <img src="<?php echo base_url();?>assets/back/img/product-list/pro2.jpg" alt=""/>
                                      <a href="#" class="adtocart">
                                          <i class="icon-shopping-cart"></i>
                                      </a>
                                  </div>
