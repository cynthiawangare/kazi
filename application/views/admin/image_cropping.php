          ...
          <section class="wrapper">
              ...
              <section class="panel">
                  ...
                  <div class="panel-body">
                      ...
                      <img src="<?php echo base_url();?>assets/back/img/gallery/3.jpg" id="demo1" alt="Jcrop Example" class="img-responsive"/>
                  ...
                  <div class="panel-body">
                      <div class="row">
                          <div class="col-md-7 col-sm-12">
                              ...
                              <img src="<?php echo base_url();?>assets/back/img/gallery/1.jpg" id="demo2" alt="Jcrop Example" class="img-responsive"/>
                          </div>
              ...
              <section class="panel">
                  ...
                  <div class="panel-body">
                      ...
                      <div class="row">
                          <div class="col-md-6">
                              <img src="<?php echo base_url();?>assets/back/img/gallery/2.jpg" id="demo3" alt="Jcrop Example" width="100%" />
                          </div>
                          <div class="col-md-6">
                              <div id="preview-pane">
                                  <div class="preview-container">
                                      <img src="<?php echo base_url();?>assets/back/img/gallery/2.jpg" class="jcrop-preview" alt="Preview"/>
                                  </div>
                              </div>
                          </div>
                      </div>
