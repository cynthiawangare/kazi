        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="<?php echo site_url('welcome/services');?>">Services</a>
              </li>
              <li class="nav-item active">
                <a class="nav-link" href="<?php echo site_url('welcome/testimonial');?>">Testimonial <span class="sr-only">(current)</span> </a>
              </li>
